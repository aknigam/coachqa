 ...
 */
public class EmailNotificationQuestionListener extends QuestionPostListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmailNotificationQuestionListener.class);
